...
WebUI.setText(findTestObject('Object Repository/Page_Automation Step by Step/input_Email_emailOne'), 'abc@gmail.com')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Automation Step by Step/input_Password_psw'), 'qgGk8kzuZkg=')
